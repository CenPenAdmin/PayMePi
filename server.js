...
app.use(cors({
    origin: function (origin, callback) {
        ...
        const allowedOrigins = [
            ...
            'https://c3f15f4b9b3a.ngrok-free.app',
...
async function getAuctionStatus() {
    ...
    auctionEnd.setHours(18, 15, 0, 0); // 6:15 PM (18:15)
    ...
    try {
        ...
        const status = {
            server: {
                running: true,
                port: PORT,
                ngrokUrl: 'https://c3f15f4b9b3a.ngrok-free.app',
                piApiKey: !!PI_API_KEY
            },
            database: {
                connected: !!db,
...
app.listen(PORT, () => {
    ...
    console.log(`Access your app via ngrok at: https://c3f15f4b9b3a.ngrok-free.app`);
    console.log(`\n🔧 DEBUG ENDPOINTS:`);
    console.log(`- System Status: https://c3f15f4b9b3a.ngrok-free.app/debug/system-status`);
    console.log(`- Test Ping: https://c3f15f4b9b3a.ngrok-free.app/debug/ping`);
    console.log(`- Test Subscription: POST https://c3f15f4b9b3a.ngrok-free.app/debug/test-subscription`);
    console.log(`- Test Bidding: POST https://c3f15f4b9b3a.ngrok-free.app/debug/test-bidding`);
    console.log(`- Test Payment: POST https://c3f15f4b9b3a.ngrok-free.app/debug/test-payment-completion`);
